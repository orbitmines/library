...
*Abstract models of computation, mathematics, calculi, theorem-provers, compilers, proof assistants, automated program synthesizers, ..., (programming) languages.*
...
## Low-level systems
*Hardware, Firmware, embedded systems, dev kits, compiler toolchains, simulators, emulators, decompilers, assemblies, ..., BIOS*
...
- **Archives, Journals, ..., Indexes**: [Mathematics Genealogy Project](https://genealogy.math.ndsu.nodak.edu/), [archive.org](https://archive.org/), [scholar.archive.org](https://scholar.archive.org/), Google Scholar, https://www.ietf.org/, 
